...
<head>
    ...
    <title>Invitation to {{ $event->title }}</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                <div class="welcome-badge">Exclusive Invitation</div>
                <h1 class="salutation">Dearest {{ $guest->name }},</h1>
                <p class="invitation-text">
                    You are cordially invited to celebrate a truly magnificent milestone with us. Your presence would
                    fill our celebration with joy. Please find the details of our event below:
                </p>
                ...
                <div class="event-card">
                    ...
                    <div class="detail-row">
                        ...
                        <span
                            class="detail-val">{{ \Carbon\Carbon::parse($event->event_date)->format('F d, Y \a\t h:i A') }}</span>
                    </div>
                    @if($event->duration)
                        <div class="detail-row">
                ...
                <p class="invitation-text" style="margin-bottom: 10px; font-weight: 600; color: #1f2937;">
                    Kindly respond to our invitation using the options below:
                </p>
